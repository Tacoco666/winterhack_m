#!/usr/bin/env python3
"""
Challenge 1: Fixed location sequential pickup
挑战1: 按固定顺序去3个已知位置抓取方块
"""

# README
# Required nodes: Nav2 bringup, detector node, pick server, drop server.
# Run: ros2 run winterhack mission_challenge1
...
# Challenge 1: 3个固定位置，按顺序访问（对应实际方块位置）
DEFAULT_GLOBAL_TARGETS = [(1.4, -1.4), (-1.4, 1.4), (0.0, 1.4)]  # RED, BLUE, YELLOW
DEFAULT_HOME = (0.0, 0.0)
RESCUE_ORDER = ["RED", "BLUE", "YELLOW"]  # 保留但不使用颜色过滤
...
class MissionChallenge1(Node):
    """Challenge 1: Fixed location sequential pickup."""

    def __init__(self) -> None:
        super().__init__("mission_challenge1")
